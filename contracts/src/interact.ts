...
import { MinaChallange1 } from './MinaChallange1.js';
...
let adminPrivatekey = PrivateKey.fromBase58("EKEdDGiN9Zd9TaSPcNjs3nB6vs9JS3WCgdsrfyEeLcQpnXNR7j6E");
...
let zkapp = new MinaChallange1(zkappAddress);
if (doProofs) {
  console.log('compile');
  await MinaChallange1.compile();
} else {
